...
function SelectWidget(_ref) {
  ...
  var _React$useState = _react["default"].useState(options.enumOptions.reduce(function (preVal, curVal) {
    return _objectSpread(_objectSpread({}, preVal), {}, _defineProperty({}, curVal.value, curVal.label));
  }, {})),
      _React$useState2 = _slicedToArray(_React$useState, 1),
      valueToLabel = _React$useState2[0];

  return /*#__PURE__*/_react["default"].createElement(_PreviewWidget["default"], {
    id: id,
    title: schema.title,
    value: schema.uniqueItems ? value.map(function (selectedItem) {
      return valueToLabel[selectedItem];
    }).join('، ') : valueToLabel[value] || ''
  });
}
