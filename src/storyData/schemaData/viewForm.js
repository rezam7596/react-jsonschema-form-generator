export const viewFormSchema = {
  ...
  properties: {
    ...
    isActive: { type: 'boolean', title: 'فعال' },
  },
  ui: { classNames: 'form-generator-theme_1' },
};
...
export const viewFormData = {
  ...
  type: 1,
  description: { title: 'تخفیف ۱۰ درصدی', text: 'ویژه باشگاه مشتریان ملت - ۵ سفر تا سقف ۱۵۰۰ تومان' },
  percentage: 10,
  upToAmount: 1500,
